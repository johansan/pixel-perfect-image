...
export async function updateImageLinkWidth(this: PixelPerfectImage, imageFile: TFile, newWidth: number) {
	await this.updateImageLinks(imageFile, (params: string[]) => {
 ...
 */
export function calculateImageScale(this: PixelPerfectImage, activeFile: TFile, imageFile: TFile, actualWidth: number): number | null {
 ...
 */
export function getCurrentImageWidth(this: PixelPerfectImage, activeFile: TFile, imageFile: TFile): number | null {
